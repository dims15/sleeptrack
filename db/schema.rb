...
ActiveRecord::Schema[8.0].define(version: 2024_12_09_142615) do
  create_table "follows", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["user_id", "following_user_id"], name: "index_unique_user_following", unique: true
  ...
  create_table "sleep_records", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "duration"
    t.index ["sleep_time", "wake_time", "user_id"], name: "index_user_unique_sleep_and_wake_times", unique: true
